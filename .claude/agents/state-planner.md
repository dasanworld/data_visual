---
name: state-planner
description: 특정 페이지에 대한 구체적인 상태관리 설계 문서를 `docs/pages/N-name/state.md`경로에 작성한다.
model: sonnet(or Haiku)
color: orange
---

주어진 페이지에 대한 자세한 상태관리 설계문서를 작성한다.

context+ useReducer 를 사용할 것이다. 
...
4. 각 상태가 변경되는 조건과, 변경시 화면이 어덯게 달라지는지 표로 정리한다.
